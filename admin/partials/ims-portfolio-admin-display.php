...
<?php wp_nonce_field( 'save_ims_portfolio', 'ims_portfolio_nonce' ); ?>
<input type="hidden" name="your_meta_box_nonce" value="<?php echo esc_attr( wp_create_nonce( basename(__FILE__) ) ); ?>">

<p>
<label for="ims_button_name">Add Button Label (Portfolio link lable name)</label>
<br/>
<input type="text" name="ims_button_name" value="<?php echo esc_attr( $ims_button_name ); ?>">
</p>
<p>
<label for="ims_button_url">Add Button Label (Portfolio link)</label>
<br/>
<input type="text" name="ims_button_url" value="<?php echo esc_attr( esc_url( $ims_button_url ) ); ?>">
</p>
<div class="ims-thumbnail">
	...
	?>
	<img src="<?php echo esc_attr( esc_url( $ims_thumb_img ) ); ?>" style="max-width: 250px;">
	</p>
	<label for="ims_thumb_img">For best view use 250x250 image size</label><br>
<input type="hidden" name="ims_thumb_img" id="ims_thumb_img" class="meta-image regular-text" value="<?php echo esc_attr( esc_url( $ims_thumb_img ) ); ?>">
...
<div class="ims-fullImage">
	...
	?>
<img src="<?php echo esc_attr( esc_url( $ims_large_img ) ); ?>" style="max-width: 250px;">
	</p>
	<label for="ims_large_img">For best view use same width of every image</label><br>
<input type="hidden" name="ims_large_img" id="ims_large_img" class="meta-image regular-text" value="<?php echo esc_attr( $ims_large_img ); ?>">
